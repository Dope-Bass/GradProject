...
class ProjectList extends Component {
    ...
    handleSubmitButton = (event) => {
        axios.post('http://127.0.0.1:8000/api/projects/', {
            ...
            start_date: `${this.state.new_proj.startDate.getFullYear()}-${this.state.new_proj.startDate.getMonth()+1}-${this.state.new_proj.startDate.getDate()}`,
            end_date: `${this.state.new_proj.endDate.getFullYear()}-${this.state.new_proj.endDate.getMonth()+1}-${this.state.new_proj.endDate.getDate()}`,
            check_date: `${this.state.new_proj.checkDate.getFullYear()}-${this.state.new_proj.checkDate.getMonth()+1}-${this.state.new_proj.checkDate.getDate()}`,
